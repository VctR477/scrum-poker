...
// 0. Добавить таймаут сокету
// 1. сделать чтобы хранились только последнии 10, а остальные удалялись (если их больше 10 проверять какой самый маленький и удалять этот файл (рекурсивно удалять))
